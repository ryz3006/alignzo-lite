-- =====================================================
-- SAFE KANBAN BOARD MIGRATION SCRIPT
-- =====================================================
-- Run this script in your Supabase SQL Editor to safely update the Kanban board schema
-- This script handles existing triggers and functions gracefully
...
BEGIN
    ...
    RAISE NOTICE 'All functions and triggers have been updated';
END $$;
