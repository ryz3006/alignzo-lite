...
-- Insert a sample configuration (you'll need to replace with your actual credentials)
-- INSERT INTO google_drive_config (client_id, client_secret) 
-- VALUES ('your-client-id-here', 'your-client-secret-here');
...
WHERE table_name IN ('google_drive_config', 'google_drive_tokens')
